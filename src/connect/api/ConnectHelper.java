...
public class ConnectHelper extends haxe.lang.HxObject
{
	...
	{
		//line 13 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
	...
	{
		//line 26 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
	...
	{
		//line 41 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
	...
	{
		//line 57 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
	...
	{
		//line 76 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
	...
	{
		//line 91 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
	...
	{
		//line 97 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
		boolean rqlParams1 = ( (haxe.lang.Runtime.eq(rqlParams, null)) ? (false) : (haxe.lang.Runtime.toBool(((java.lang.Boolean) (rqlParams) ))) );
		//line 98 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
		java.lang.String paramsStr = ( (( params != null )) ? (( (rqlParams1) ? (params.toString()) : (params.toPlain()) )) : ("") );
		//line 101 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
		java.lang.String url = ( ( connect.Env.getConfig().getApiUrl() + path ) + paramsStr );
		//line 102 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
	...
	{
		//line 107 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
	...
	{
		//line 113 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
		if (( contentType == null )) 
		{
			//line 113 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
		...
		//line 114 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
		connect.util.Dictionary headers = new connect.util.Dictionary();
		//line 115 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
		headers.set("Authorization", connect.Env.getConfig().getApiKey());
		//line 116 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
		headers.set("Content-Type", contentType);
		//line 117 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
		return headers;
	}
	...
	{
		//line 122 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
		if (( response.status < 400 )) 
		{
			//line 123 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
			return response.text;
		}
		else
		{
			//line 125 "/home/travis/build/JaviCerveraIngram/connect-haxe-sdk/connect/api/ConnectHelper.hx"
