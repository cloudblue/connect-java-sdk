...
public class ApiClientImpl extends connect.Base implements connect.api.IApiClient
{
	...
	{
		//line 44 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
	...
	public static void logRequest(int level, java.lang.String method, java.lang.String url, connect.util.Dictionary headers, java.lang.String body, connect.api.Response response)
	{
		...
		//line 192 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
		{
			...
			while (output.hasNext())
			{
				...
				if (( headers != null )) 
				{
					//line 196 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
				...
				{
					//line 202 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
					requestList.push(( "Status: " + response.status ));
					//line 203 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
	...
	public static java.lang.String getHeadersTable(connect.util.Dictionary headers, connect.logger.ILoggerFormatter fmt)
	{
		...
		//line 220 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
	...
	public static connect.util.Dictionary maskHeaders(connect.util.Dictionary headers)
	{
		...
		//line 233 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
		{
			...
			while (haxe.lang.Runtime.toBool(((java.lang.Boolean) (haxe.lang.Runtime.callField(key, "hasNext", null)) )))
			{
				...
				{
					//line 235 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
					java.lang.String auth = haxe.root.Std.string(headers.get("Authorization"));
					//line 236 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
					haxe.root.Array<java.lang.String> parts = haxe.lang.StringExt.split(auth, ":");
					//line 237 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
					java.lang.String join = ( (( parts.length > 1 )) ? (parts.slice(1, null).join(":")) : ("") );
					//line 238 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
				...
				{
					//line 245 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
	...
	public static java.lang.String getFormattedData(java.lang.String data, java.lang.String title, connect.logger.ILoggerFormatter fmt)
	{
		...
		{
			//line 255 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
	...
	{
		//line 28 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
		connect.api.Response response = this.syncRequestStd(method, url, headers, body, fileArg, fileName, fileContent);
		//line 31 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
		int level = ( (( ( response.status >= 400 ) || ( response.status == -1 ) )) ? (connect.logger.Logger.LEVEL_ERROR) : (connect.logger.Logger.LEVEL_INFO) );
		//line 34 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
		...
		if (( response.status != -1 )) 
		{
			//line 37 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
			return response;
		}
		else
		{
	...
	public connect.api.Response syncRequestStd(java.lang.String method, java.lang.String url, connect.util.Dictionary headers, java.lang.String body, java.lang.String fileArg, java.lang.String fileName, connect.util.Blob fileContent)
	{
		...
		//line 150 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
		...
		//line 155 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
		if (( headers != null )) 
		{
			//line 156 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
			java.lang.Object key = headers.keys();
			//line 156 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
			while (haxe.lang.Runtime.toBool(((java.lang.Boolean) (haxe.lang.Runtime.callField(key, "hasNext", null)) )))
			{
		...
		//line 165 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
		if (( ( ( fileArg != null ) && ( fileName != null ) ) && ( fileContent != null ) )) 
		{
			//line 166 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
		...
		//line 175 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
		...
		//line 182 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
		while (haxe.lang.Runtime.eq(status[0], null))
		{
		}
		
		//line 183 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
		haxe.io.Bytes bytes = responseBytes.getBytes();
		//line 184 "/home/travis/build/cloudblue/connect-haxe-sdk/connect/api/impl/ApiClientImpl.hx"
